...
*}
<!DOCTYPE html>
<html {$langHeader} ng-app="suite_angular_app" ng-controller="suite_angular_controller">
<head>
    ...
    <link href="themes/SuiteP/angular/views/list-view.txt" rel="stylesheet" type="text/css"/>
    ...
    <script type="text/javascript" src='themes/SuiteP/angular/js/Cases.js'></script>
</head>