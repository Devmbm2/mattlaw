...
*}
	...
	<form id="CalendarEditView" name="CalendarEditView" method="POST">
		...
		<input type="hidden" name="current_module" id="current_module" value="FP_events">
		...
		<div>
			{literal}
				<input type="radio" id="radio_meeting" value="FP_events" onclick="CAL.change_activity_type(this.value);" checked="true"  name="appttype" tabindex="100"/>
			{/literal}
			<label for="radio_meeting">Schedule Events</label>
			{literal}
	...
	<link href='custom/include/select2/css/select2.min.css' rel='stylesheet' type='text/css'/>
