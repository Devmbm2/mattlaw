...
{literal}
			...
			function select_all_users(element){
			...
			<div class="modal-body">
				...
				<div class="container-fluid">
					<div class="panel panel-default ">
						...
						<div id="subpanel_settings_user_list" class="panel-body panel-collapse collapse in"  style=" height: 400px; overflow: auto;">
								...
								<table cellpadding="0" cellspacing="3" border="0" align="center" width="100%">
									...
									<tr><td valign="top"></td><td valign="top">
											<table cellpadding="1" cellspacing="1" border="0" align="center">
												<tr><th><input id="top_check" title="Select all Users" checked="checked" onclick="select_all_users(this)" type="checkbox"></th><th>{$MOD.LBL_USERS}</th><th>{$MOD.LBL_BORDER}</th></tr>
												{foreach from=$users_list key=user_id item=user_name}
												<tr>
													<td valign="top" align="center" nowrap=""><input type="checkbox" name="shared_ids[]" value="{$user_id}" {if $user_id|in_array:$shared_ids} checked="checked" {/if}/></td>
													<td valign="top" align="center">
														{$user_name}
													</td>
													<td>
													<input type="text" id="shared_ids_colors_{$user_id}" name="shared_ids_colors[{$user_id}]" class="color" value="{$shared_ids_colors.$user_id}" size="8" />
													</td>
												</tr>
												{/foreach}
											</table>
