    ...
    <div class="container-fluid">
                                        ...
                                        <li>
                                            <ul class="favorite-list">
                                                {foreach from=$favoriteRecords item=item name=lastViewed}
                                                    {if $smarty.foreach.lastViewed.iteration < 10} {* limit to 9 results *}
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            {/foreach}
                                                <li>
                                                    <ul>
                                                        ...
                                                        {foreach from=$recentRecords item=item name=lastViewed}
                                                            {if $item.module_name == $name and $submoduleRecentRecords < 11}
                                                                <li class="recentlinks" role="presentation">
                                                                    <a title="{$item.module_name}"
                                                                       accessKey="{$smarty.foreach.lastViewed.iteration}"
                                                                       href="{sugar_link module=$item.module_name action='DetailView' record=$item.item_id link_only=1}" class="recent-links-detail">
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    {foreach from=$favoriteRecords item=item name=lastViewed}
                                                        {if $item.module_name == $name and $submoduleFavoriteRecords < 8}
                                                            <li class="favoritelinks" role="presentation">
                                                                <a title="{$item.module_name}"
                                                                   accessKey="{$smarty.foreach.lastViewed.iteration}"
                                                                   href="{sugar_link module=$item.module_name action='DetailView' record=$item.id link_only=1}" class="favorite-links-detail">
            ...
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
						...
						<li>
                            <a href="index.php?module=Home&action=generate_doc">Generate Document</a>
                        </li>
                        <li>
                            <a href="index.php?module=Contacts&action=EditView&return_module=Contacts&return_action=DetailView">{$APP.LBL_QUICK_CONTACT}</a>
                        </li>
                        <li>
                            <a href="index.php?module=FP_events&action=EditView&return_module=FP_events&return_action=DetailView">{$APP.LBL_QUICK_EVENT}</a>
			</li>
			<li> 
                            <a href="index.php?module=Cases&action=EditView&return_module=Cases&return_action=DetailView">{$APP.LBL_QUICK_CASE}</a>
                        </li>
                        <li>
                            <a href="index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView">{$APP.LBL_QUICK_NOTE}</a>
                        </li>
                        <li>
        ...
        <div class="desktop-bar">
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a href="index.php?module=Cases&action=statueoflimitation&return_module=Cases&return_action=DetailView">Statue of limitation</a>
                             </li>
                        <li>
                            <a href="index.php?module=Contacts&action=EditView&return_module=Contacts&return_action=DetailView">{$APP.LBL_QUICK_CONTACT}</a>
                        </li>
			...
			<li>
                        ...
                        <li>
                            <a href="index.php?module=Cases&action=case_reports">Generate Custom Reports</a>
                             </li>
                    </ul>
                </li>
                <li id="" class="dropdown nav navbar-nav navbar-search">
            ...
            <!--<div {if $smarty.cookies.sidebartoggle == 'collapsed'}style="display:none"{/if}
             ...
             class="sidebar">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        {foreach from=$recentRecords item=item name=lastViewed}
                            ...
                            <div class="recently_viewed_link_container_sidebar">
                                <li class="recentlinks" role="presentation">
                                    <a target="_blank" title="{$item.module_name}" accessKey="{$smarty.foreach.lastViewed.iteration}" href="{sugar_link module=$item.module_name action='DetailView' record=$item.item_id link_only=1}" class="recent-links-detail">
                ...
                {/if}
                    <ul class="nav nav-pills nav-stacked">
                        {foreach from=$favoriteRecords item=item name=lastViewed}
                            {if $smarty.foreach.lastViewed.index < 8}
                            <div class="recently_viewed_link_container_sidebar">
                                <li class="recentlinks" role="presentation">
