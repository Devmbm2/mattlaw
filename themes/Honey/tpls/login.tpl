...
<div class="p_login">
	...
	<div class="p_login_top">
		...
		<a title="Honey" href="https://honey.law">Honey</a>
    ...
    <div id="loginform">
        ...
        <form class="form-signin" role="form" action="index.php" method="post" name="DetailView" id="form"
            ...
            <div class="companylogo"><img src="themes/Honey/images/company-honey.png" alt="Honey" style="margin: 0px 0;"><!--{$LOGIN_IMAGE}--></div>
