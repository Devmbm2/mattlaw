...
// El prefijo "Custom" en el nombre de la clase no es imprescindible, a menos que ya exista otra clase para el modulo en /modules y ésta tenga que descender de la que ya existe (el funcionamiento es igual que con otras clases de Sugar)
