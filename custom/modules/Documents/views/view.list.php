...
EOHTML;
	...
	if (!$this->headers)
        ...
        if($_REQUEST['email_documents']=='yes'){
			$this->params['custom_where'] = " AND documents.email_documents =1 ";
		}   else{
			$this->params['custom_where'] = " AND documents.email_documents =0 ";
        }
        ...
        $this->params['custom_where'] = " AND cases.id = '{$search}'";
            }
			/* echo $this->where;die;
