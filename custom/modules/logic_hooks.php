...
$hook_array['after_delete'][] = Array(100, 'after_delete', 'modules/UsersActivity/UsersActivityLogicHooks.php','UsersActivityLogicHooks', 'after_delete'); 
...
$hook_array['after_ui_frame'] = Array(); 
$hook_array['after_ui_frame'][] = Array(1, 'after_ui_frame', 'modules/UsersActivity/UsersActivityLogicHooks.php','UsersActivityLogicHooks', 'after_ui_frame'); 
