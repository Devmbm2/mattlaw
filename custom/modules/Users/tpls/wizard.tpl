                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td scope="row">
                                ...
                                <div class="userWizWelcome"><img src='custom/images/sugar_wizard_welcome.png' border='0' alt='{$MOD.LBL_WIZARD_WELCOME_TAB}' width='765px' height='325px'></div>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <td>
                <div class="edit view">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
						 <td scope="row">
							<div class="userWizWelcome"><img src='custom/images/sugar_wizard_finish.png' border='0' alt='{$MOD.LBL_WIZARD_FINISH_TITLE}' width='765px' height='325px'></div>
                        </td>
