...
{$multiSelectData}
{if $hideTable == false}
<input type="text" name="search" id="search" class="form-control" placeholder="Leads Search Leads Name , Case Type , Mobile Number , Source">
...
{if $contextMenus}
    ...
    {literal}
        <script type="text/javascript">
        $(document).ready(function() {
            let beforeAppend = $("#main_table").html();
            $('#search').on( 'keyup', function () {
                ...
                if (searcheditem !== "") {
                    $('#main_table').DataTable( {
                        ...
                        "lengthChange": false,
                        ajax: {
                            url:"index.php?module=Leads&action=SearchLeads",
                            type: "post",
                        ...
                        "columns":[
                            ...
                            "render": function ( data, type, row, meta ) {
                                        return '<input title="Select this row" onclick="sListView.check_item(this, document.MassUpdate)" type="checkbox" class="checkbox" name="mass[]" value="'+row.id+'">';
                                      }
                            },
                            {data:"id",
                            "render": function ( data, type, row, meta ) {
                                        return '<a title="Edit" id="edit-'+row.id+'" href="index.php?module=Leads&amp;offset=2&amp;stamp=1652868055059206000&amp;return_module=Leads&amp;action=EditView&amp;record='+row.id+'"><img src="themes/Honey/images/edit_inline.gif?v=V6Jf_6LIk4nKTRgtYTnxCA" border="0" alt="Edit"></a>';
                                      }
                            },
                            {data:"date_entered"},
                            {data:"salutation",
                            ...
                            {data:"converted",
                            "render":function(data, type, row, meta){
                                return '<input type="checkbox" class="checkbox" disabled="true">';
                            }
                            },
                            {data:'id',
                            "render":function( data, type, row, meta){
                                    return '<img vertical-align="middle" class="info" border="0" alt="Additional Details" src="themes/Honey/images/info_inline.gif?v=V6Jf_6LIk4nKTRgtYTnxCA">';
                                }
                            },
                        ]
                    } );
                    ...
                    $("#main_table").empty();
                    $("#main_table").append(beforeAppend);
                }
            });
        });
        </script>
