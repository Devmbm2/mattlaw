...
{if $hideTable == false}
	<div class="list-view-rounded-corners">
		<input type="text" name="search" id="search" class="form-control" placeholder="Contact Search First name, Last name, Salutation, First name Last name, Last name First name">
...
$('table tbody tr td:nth-last-child(2) img').remove();
$('#tbody_id  tr td:nth-last-child(2) #cesms').append('<a href="https://familyeducation.voippbxsite.net/App?OPTION=WebPhoneApp" target = "_blank" title="Call with VoIP"><img src="'+base_url+'/themes/Honey/images/webphone.svg" style="" alt="Image" width="25" height="25"/></a>');
let beforeAppend = $("#tbody_id").html();
$('#search').on( 'keyup', function () {
let searcheditem = $('#search').val();
if (searcheditem !== "") {
$.ajax({
            url:"index.php?module=Contacts&action=livesearch",   
            type: "post",
            //dataType: 'json',
	...
	if(v.last_name != null || v.first_name != null||v.account_name != null||v.phone_work != null||v.phone_mobile != null||v.country_code_phone != null||v.type_c != null)				
{
if(v.account_name == null)
				{
				v.account_name = "";
				}				
...
<td><a target="_blank" title="Edit" id="edit-${v.id}" href="index.php?module=Contacts&amp;offset=2&amp;stamp=1641484446063359800&amp;return_module=Contacts&amp;action=EditView&amp;record=${v.id}"><img src="themes/Honey/images/edit_inline.gif?v=V6Jf_6LIk4nKTRgtYTnxCA" border="0" alt="Edit"><!-- </a> -->
</a></td>
<td><a target="_blank" href="index.php?module=Contacts&amp;offset=2&amp;stamp=1641484446063359800&amp;return_module=Contacts&amp;action=DetailView&amp;record=${v.id}">
${v.last_name}
&nbsp;</a></td>
<td><a target="_blank" href="index.php?module=Contacts&amp;offset=2&amp;stamp=1641484446063359800&amp;return_module=Contacts&amp;action=DetailView&amp;record=${v.id}">
${v.first_name}
</a></td><td><a target="_blank" href="index.php?module=Contacts&amp;offset=2&amp;stamp=1641484446063359800&amp;return_module=Contacts&amp;action=DetailView&amp;record=${v.id}">
${v.salutation} ${v.first_name} ${v.last_name}
</a></td>
<td><a style="color: black;font-weight: bold;font-size: 13px;" target="_blank" href="?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3DAccounts%26offset%3D2%26stamp%3D1641484446063359800%26return_module%3DAccounts%26action%3DDetailView%26record%3D${v.account_id}">
${v.account_name}
&nbsp;</a></td>

<td>${v.type_c}&nbsp;</td><td>
<div id="cesms">
<img style="cursor:pointer;vertical-align: sub;" src="custom/themes/default/images/messages.png" onclick="smstonumber('${v.phone_work}','Contacts','${v.id}');">
</div>
${v.phone_work}</td><td>${v.phone_mobile}
&nbsp;</td><td>
<div id="cesms">
<a href="https://familyeducation.voippbxsite.net/App?OPTION=WebPhoneApp" target="_blank" title="Call with VoIP"><img src="https://honey.mattlaw.com/themes/Honey/images/webphone.svg" style="" alt="Image" width="25" height="25"></a></div>
<a href="tel:${v.country_code_phone}">${v.country_code_phone}</a></td>
