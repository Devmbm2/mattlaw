...
$CONTACT_ROLE_OPTIONS = get_select_options_with_id($app_list_strings['relationship_to_case_list'], $focus->contact_role);
$html = '
	<table>
	<tr>
	<td scope="row"><slot>Contact Role</slot></td>
	<td ><slot><select name="contact_role" id="contact_role">'.$CONTACT_ROLE_OPTIONS.'</select></slot></td>
