...
<tr>
    ...
    {{/if}}
{{* yaha say sare labels create ho rahe ha nichy wale if say *}}
...
{{* yaha say sari input fields a rahi ha  *}}
			...
			{{elseif $fields[$colData.field.name]}}
				{{* {php}
				if($fields[$colData.field.name]==='Assigned record to user'){
					print_r($fields);die();
					}
				{/php} *}}
				{counter name="panelFieldCount"}
...
<tr>
<td colspan='4'>
<div class="col-xs-12 col-sm-6 edit-view-field " type="text" field="case_description_c" colspan="3" >
...
<tr>
	<td colspan='4'>
			<table style="width:80%; margin-left:120px; " id="map_table" >
			<thead style=" margin-left:120px; ">
			<th style="width:10%"></th>
			<th style="width:35%">Module fields:</th>
			<th style="width:35%">Email Tag Name:</th>
			</thead>
				<tbody>
				</tbody>
			</table>
...
{literal}
	...
	$('#convert_to_module').on('change',function(){
	  // $('#check_duplicate').css('width','250px');
	   ajaxGeneralFunction({moduleName:$('#convert_to_module').val()},'#check_duplicate','index.php?module=ht_EmailExtract&action=GetAllModulesFromDatabase&onChangeModule=true');
	});
	</script>
	{/literal}
