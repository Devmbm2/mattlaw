...
{$jsLang}
{$LIST_HEADER}
<script type="text/javascript" src="{sugar_getjspath file='custom/modules/Accounts/js/selectionRole.js'}"></script>
{if $should_process}
...
<div class="message_dialog" id="message_dialog_role" style="background-color:white;">
</div>
</div>