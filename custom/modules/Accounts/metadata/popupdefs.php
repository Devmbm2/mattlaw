...
// $sql = "select distinct accounts_cases.account_id as parent_id From accounts INNER JOIN accounts_cases ON accounts.id=accounts_cases.account_id where accounts_cases.case_id='{$this_parent}' AND accounts_cases.deleted = 0";
// $result = $db->query($sql);
