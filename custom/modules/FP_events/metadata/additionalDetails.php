...
function additionalDetailsFP_events($fields, SugarBean $bean, $params = array()) {
    global $current_language, $timedate, $app_list_strings;
        ...
        $caption = $templateCaption->fetch('custom/modules/'. $bean->module_name .'/tpls/additionalDetails.caption.tpl');
        ...
        $body = $templateBody->fetch('custom/modules/'. $bean->module_name .'/tpls/additionalDetails.body.tpl');
