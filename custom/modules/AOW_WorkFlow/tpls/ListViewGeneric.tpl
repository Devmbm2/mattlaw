...
$('#search_u').keyup(function(){
  ...
  $.ajax({
  url:"index.php?module=AOW_WorkFlow&action=index&return_module=AOW_WorkFlow&return_action=ListView&clear_query=true&search_data=searcheditem",
  type: "post",
  data:
...
{if $hideTable == false}
  ...
  <input type="text" name="search_u" id="search_u"  placeholder="Search with Workflow Name" size="180" maxlength="255" value="" title="">
  </div>
