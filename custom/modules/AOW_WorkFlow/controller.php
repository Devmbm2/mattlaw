...
/*            foreach($graphs as $g)
    ...
    public function action_select_workflow_manually(){
        ...
        $casesBean->cases_aow_workflow_1->add($workflowBean);

                 $query3="select * from  `aow_workflow` inner join cases_aow_workflow_1_c on aow_workflow.id=cases_aow_workflow_1_c.cases_aow_workflow_1aow_workflow_idb";
                 $result3 = $db->query($query3);
                 $output="";
                 while ($record = $db->fetchByAssoc($result3)) {
                         $output.='<tr class="oddListRowS1">
                         <td class="footable-first-visible" style="display: table-cell;"></td><td style="display: table-cell;">
...
// echo "</pre>";
    ...
    public function action_Load_All_Workflows(){
        global $db;
        $query="select aow_workflow.* from  `aow_workflow` inner join cases_aow_workflow_1_c on aow_workflow.id=cases_aow_workflow_1_c.cases_aow_workflow_1aow_workflow_idb where cases_aow_workflow_1_c.cases_aow_workflow_1cases_ida='".$_POST['record_id']."'";
