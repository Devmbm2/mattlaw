...
$CASE_ROLE_OPTIONS = get_select_options_with_id($app_list_strings['relationship_to_case_list'], $focus->case_role);
$html = '
	<table>
	<tr>
	<td scope="row"><slot>Case Role</slot></td>
	<td ><slot><select name="case_role" id="case_role">'.$CASE_ROLE_OPTIONS.'</select></slot></td>
