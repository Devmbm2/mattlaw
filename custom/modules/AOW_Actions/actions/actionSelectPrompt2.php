...
class actionSelectPrompt2 extends actionBase {
    ...
    function loadJS(){
        return array('custom/modules/AOW_Actions/actions/actionSelectPrompt2.js');
    }
    /**
...
.close{
        ...
        <div class="" role="document">
          <div class="modal-content">
            ...
            <label>Modules</label><br>
              ...
              <select name="AllWorkFlows" id="AllWorkFlows" multiple style="width:200px;">
              ';
              $html.='</select>
   ...
   // padding: 0.375rem 0.75rem;
    ...
    transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;
              " data-dismiss="modal" onclick="SelectWorkFlowAndAssign(this)">Select</button>
            </div>
          </div>
        </div>
      </div>
