...
if($_REQUEST['method'] == 'validate') {
    htLoginTrackerOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    htLoginTrackerOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    htLoginTrackerOutfittersLicense::add();
    ...
    $validate_license = htLoginTrackerOutfittersLicense::isValid($currentModule,$user_id,true);
