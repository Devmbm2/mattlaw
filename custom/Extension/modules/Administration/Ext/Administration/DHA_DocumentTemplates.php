...
$admin_option_defs['Administration']['DHA_PlantillasDocumentos_template']= array(
   'DHA_PlantillasDocumentos',
   translate('LBL_MODULE_CONFIG_TEMPLATE', 'DHA_PlantillasDocumentos'),
   translate('LBL_MODULE_CONFIG_TEMPLATE', 'DHA_PlantillasDocumentos'),
   'index.php?module=DHA_PlantillasDocumentos&action=DocTemplateConfiguration'
);  
