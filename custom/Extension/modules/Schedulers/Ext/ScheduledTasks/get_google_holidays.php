<?php
$job_strings[] = 'get_google_holidays';
function get_google_holidays()
{
	...
	foreach($holidays AS $holiday){
        ...
        $eventBean->description = $holiday['creator']['displayName'].' '.$holiday['htmlLink'];
        ...
        $eventBean->type_c = 'Public_Holiday';
		$eventBean->save();
	}
