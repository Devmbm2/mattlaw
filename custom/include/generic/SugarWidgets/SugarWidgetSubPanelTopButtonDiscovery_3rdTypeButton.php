...
class SugarWidgetSubPanelTopButtonDiscovery_3rdTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$button .= "<input type='hidden' name='type' value='3rd_Non_Party_Requests'>\n";
		$button .= "</form>";
		return $button;
