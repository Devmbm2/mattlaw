...
class SugarWidgetSubPanelTopButtonQCdefendant_insuranceTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$button .= "<input type='hidden' name='subcategory_id' value='Defendant_Insurance'>\n";
		$button .= "</form>";
		return $button;
