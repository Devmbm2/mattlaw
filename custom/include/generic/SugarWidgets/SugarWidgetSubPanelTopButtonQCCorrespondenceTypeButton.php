...
class SugarWidgetSubPanelTopButtonQCCorrespondenceTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$button .= "<input type='hidden' name='subcategory_id' value='Correspondence'>\n";
		$button .= "</form>";
		return $button;
