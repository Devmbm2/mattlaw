...
class SugarWidgetSubPanelTopButtonQCClient_InsuranceTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$button .= "<input type='hidden' name='subcategory_id' value='Client_Insurance'>\n";
		$button .= "</form>";
		return $button;
