...
class SugarWidgetSubPanelTopSelectAccountButton extends SugarWidgetSubPanelTopButton
{
    ...
    {
        return $this->module_name . '_select_button';
    }

    public function getDisplayName()
    {
        return $GLOBALS['app_strings']['LBL_SELECT_ACCOUNT_BUTTON_LABEL'];
    }
	...
	function display($widget_data, $additionalFormFields = NULL, $nonbutton = false)
	{
		...
		$popup_request_data = array(
			...
			'passthru_data' => array(
				...
				if (!empty($widget_data['add_to_passthru_data']))
                {
                    $popup_request_data['passthru_data']= array_merge($popup_request_data['passthru_data'],$widget_data['add_to_passthru_data']);
                }
		...
		return ' <input type="button" name="' . $subpanel_name.'_'.$this->getWidgetId() . '" id="' .$subpanel_name.'_'. $this->getWidgetId() . '" class="button"' . "\n"
				. ' title="' . $this->title . '"'
			. ' value="' . $this->value . "\"\n"
    ...
    */
    ...
    {
       return translate('LBL_SELECT_ACCOUNT_BUTTON_TITLE');
    }
