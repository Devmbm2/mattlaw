...
class SugarWidgetSubPanelTopButtonQuickCreateSoftButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$value = $app_strings['LBL_NEW_BUTTON_LABEL_FOR_CASES_SOFT_DOCUMENTS'];
