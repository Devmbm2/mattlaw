...
class SugarWidgetSubPanelTopButtonQuickCreateSoftButtonTemplate extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$value = $app_strings['LBL_NEW_BUTTON_TITLE_TEMPLATE_GENERATE'];
		...
		$button .= "</form>"; */
		$button = "<input title='$title' class='button' type='submit' name='{$this->getWidgetId()}' id='{$this->getWidgetId()}' value='  $value  ' onclick='ht_showMassGenerateDocumentForm(\"all\");' />\n";
		return $button;
