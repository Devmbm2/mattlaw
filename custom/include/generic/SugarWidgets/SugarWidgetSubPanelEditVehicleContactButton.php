...
class SugarWidgetSubPanelEditVehicleContactButton extends SugarWidgetField
{
	...
	{
		/* print"<pre>";print_r($layout_def); */
		global $app_strings;
        global $subpanel_item_count;
        $unique_id = $layout_def['subpanel_id']."_edit_".$subpanel_item_count; //bug 51512
		print"<pre>";print_r($layout_def);die;
		$href = 'index.php?module=' . $layout_def['module']
			. '&action=' . 'VehicleContactRelationshipEdit'
			. '&record=' . $layout_def['fields']['CASE_ROLE_ID']
