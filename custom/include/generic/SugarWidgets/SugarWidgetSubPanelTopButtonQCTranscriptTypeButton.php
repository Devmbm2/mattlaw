...
class SugarWidgetSubPanelTopButtonQCTranscriptTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$button .= "<input type='hidden' name='subcategory_id' value='Transcripts_Statements'>\n";
		$button .= "</form>";
		return $button;
