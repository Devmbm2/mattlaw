...
class SugarWidgetSubPanelTopButtonQCHardTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function &_get_form($defines, $additionalFormFields = null, $asUrl = false)
	{
		...
		$form = 'form' . $defines['subpanel_definition']->_instance_properties['subpanel_name'];
