...
class SugarWidgetSubPanelTopSelectContactButton extends SugarWidgetSubPanelTopButton
{
    ...
    {
        return $GLOBALS['app_strings']['LBL_SELECT_CONTACT_BUTTON_LABEL'];
    }
    ...
    */
    ...
    {
       return translate('LBL_SELECT_CONTACT_BUTTON_TITLE');
    }
