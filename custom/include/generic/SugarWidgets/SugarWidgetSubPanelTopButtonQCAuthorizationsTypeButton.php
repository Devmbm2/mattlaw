...
class SugarWidgetSubPanelTopButtonQCAuthorizationsTypeButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	...
	function display($defines)
	{
		...
		$button .= "<input type='hidden' name='subcategory_id' value='Authorizations'>\n";
		$button .= "</form>";
		return $button;
