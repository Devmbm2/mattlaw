$(document).ready(function() {
	if(document.getElementsByName('source_c').length > 0 ){
		initComplaintSource();
		changeComplaintSource(); //Call onchange function
	}
});
function initComplaintSource(){
...
function changeComplaintSource(){
     document.getElementById("source_c").onchange = function() {
        initComplaintSource(); //Call hide/show function
    }
}
