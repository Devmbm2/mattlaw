...
jQuery('div').filter('[field="{{$displayParams.key}}_of_incident_c"]').removeClass('inlineEdit');
</script>
<script type="text/javascript" src='{sugar_getjspath file="custom/include/SugarFields/Fields/LocationAddress/mapDetail.js"}'></script>
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
<tr>
<td width='99%'>
<input type="hidden" class="sugar_field" id="{{$displayParams.key}}_of_of_incident_c" value="{$fields.{{$displayParams.key}}_of_incident_c.value|escape:'html_entity_decode'|escape:'html'|url2html|nl2br}">
...
{$fields.{{$displayParams.key}}_of_incident_c.value|escape:'html_entity_decode'|escape:'html'|url2html|nl2br}<br>
