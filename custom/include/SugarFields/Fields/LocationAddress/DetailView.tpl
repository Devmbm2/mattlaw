...
<tr>
<td width='99%' >
<input type="hidden" class="sugar_field" id="{{$displayParams.key}}_of_incident_c" value="{$fields.{{$displayParams.key}}_address_street.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
...
{$fields.{{$displayParams.key}}_of_incident_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>
