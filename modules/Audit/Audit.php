   ...
   function get_audit_list()
    {
        ...
        if($focus->is_AuditEnabled()){
		    ...
		    $result = $focus->db->query($query);
				...
				$audit_list[] = array('field_name' => 'Record Created By', 'before_value_string' => $focus->created_by_name, 'created_by' => $focus->created_by_name, 'date_created' => $focus->date_entered);
        }
        return $audit_list;
    }
