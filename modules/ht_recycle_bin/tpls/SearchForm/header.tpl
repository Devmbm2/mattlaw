...
<form name='search_form' id='search_form' class='search_form{if !$searchFormInPopup} non-popup{/if}' method='post' action='index.php?module=ht_recycle_bin&action={$action}' onkeydown='submitOnEnter(event);'>
