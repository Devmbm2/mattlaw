...
require_once('modules/ht_recycle_bin/ListView/ListViewDisplayCstm.php');


require_once('include/contextMenus/contextMenu.php');

class ListViewSmartyCstm extends ListViewDisplayCstm
{
    ...
    private function getSearchIcon() {
        ...
        return $ss->fetch('modules/ht_recycle_bin/ListView/tpls/ListViewSearchLink.tpl') . '<br>';
    }
