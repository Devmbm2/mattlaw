...
class ListViewDataCstm {
	...
	function getListViewData($seed, $where, $offset=-1, $limit = -1, $filter_fields=array(),$params=array(),$id_field = 'id',$singleSelect=true) {
		...
		$ret_array = $seed->create_new_list_query($orderBy, $where, $filter_fields, $params, 1, '', true, $seed, $singleSelect);
