<?php
   ...
   */
   ...
   function MailMergeReports_after_ui_frame_hook($event, $arguments) {
	  ...
	  if(strpos(strtolower($current_theme),'honey')  !== false){
		  $current_theme = 'Honey';
	  }
      ...
      <script type="text/javascript" language="JavaScript"> 
         ...
         jQuery( document ).ready(function() {  
            ...
            if (isSuiteCRM && currentTheme == 'Honey') {
			...
			if('{$module}' == 'Cases' || '{$module}' =='Contacts' || '{$module}' =='Leads' || '{$module}' =='Accounts'|| '{$module}' =='Complaints'){
				var action_code_list = '';
				var action_code_button = '';               
				action_code_list += '<li><a id="ht_generate_document_button" onclick="ht_showMassGenerateDocumentForm();">{$app_strings['LBL_GENERAR_DOCUMENTO_POPOUP']}</a></li>';
				// action_code_list += '<li><a id="ht_generate_document_button" onclick="ht_showMassGeneratePresentationForm();">{$app_strings['LBL_GENERAR_DOCUMENTO_PRESENTATION']}</a></li>';
				action_code_button += '<button class="dropdown button" style="padding: 0px !important;"><a title="{$app_strings['LBL_GENERAR_DOCUMENTO']}" class="button dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button"  >{$app_strings['LBL_GENERAR_DOCUMENTO']}<span class="caret"></span>'
  +'</a>'
 +'<ul class="dropdown-menu">'
    +'<li><a name="generate_document_button" id="ht_generate_document_button" href="javascript:ht_showMassGenerateDocumentForm();">Search Filter</a></li>'
    +'<li><a href="javascript:ht_showMassGenerateDocumentForm(\'favorites\');">Favorites</a></li>'
    +'<li><a href="javascript:ht_showMassGenerateDocumentForm(\'all\');">Name Search</a></li>'
  +'</ul></button>'; 
				// action_code_button += '<span> </span><input title="{$app_strings['LBL_GENERAR_DOCUMENTO_PRESENTATION']}" class="button" onclick="ht_showMassGenerateDocumentForm();" type="button" id="ht_generate_document_button" name="generate_document_button" value="{$app_strings['LBL_GENERAR_DOCUMENTO_PRESENTATION']}">';               
			}
            if ({$with_buttons}) {
               if (isSuiteCRM && currentTheme == 'Honey') {
...
EOHTML;
         ...
         $ht_action_code_list_top = "<a href=\"#ht_massgeneratedocument_form\" id=\"ht_massgeneratedocument_listview_top\" onclick=\"ht_showMassGenerateDocumentForm();\">{$app_strings['LBL_GENERAR_DOCUMENTO']}</a>";
         ...
         $ht_action_code_list_bottom = str_replace("ht_massgeneratedocument_listview_top", "ht_massgeneratedocument_listview_bottom", $action_code_list_top);  
      ...
      <script type="text/javascript" language="JavaScript"> 
         ...
         jQuery( document ).ready(function() {
           ...
           // action_code_list_top += '<li>{$ht_action_code_list_top}</li>';
            var action_code_list_bottom = '<li>{$action_code_list_bottom}</li>';
            //action_code_list_bottom += '<li>{$ht_action_code_list_bottom}</li>';
