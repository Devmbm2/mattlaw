...
class DHA_PlantillasDocumentosViewConfig_template extends SugarView {
   ...
   public function display() {
      ...
      echo getClassicModuleTitle(
            ...
            array(
               "<a href='index.php?module=DHA_PlantillasDocumentos&action=index'>{$app_list_strings['moduleList']['DHA_PlantillasDocumentos']}</a>",
               $mod_strings['LBL_MODULE_CONFIG_TEMPLATE'], //$mod_strings['LBL_CONFIG'],
            ), 
            false
      );
        
      echo $this->ss->fetch('modules/DHA_PlantillasDocumentos/views/view.config_template.tpl');
   }
