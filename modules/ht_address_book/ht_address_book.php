...
class ht_address_book extends Company
{
    public $new_schema = true;
    public $module_dir = 'ht_address_book';
    public $object_name = 'ht_address_book';
    public $table_name = 'ht_address_book';
