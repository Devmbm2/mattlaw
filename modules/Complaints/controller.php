...
class ComplaintsController extends SugarController
{
    ...
    public function action_get_kb_articles()
    {
        ...
        $relevanceCalculation = "COMPLAINT WHEN name LIKE '$search' THEN 10 
                                ELSE 0 END + COMPLAINT WHEN name LIKE '%$search%' THEN 5 
                                ELSE 0 END + COMPLAINT WHEN description LIKE '%$search%' THEN 2 ELSE 0 END";
