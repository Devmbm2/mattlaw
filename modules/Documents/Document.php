...
class Document extends File {
 ...
 public $importable = true;
	...
	function fill_in_additional_detail_fields() {
		...
		if($this->doc_type == 'Local'){
			$this->filename = $this->document_name;
			//populate name
            if(isset($this->document_name))
            {
            	$this->name = $this->document_name;
	...
	function get_list_view_data() {
		...
		$document_fields['CATEGORY_ID'] = empty ($this->category_id) ? "" : $app_list_strings['incoming_or_outgoing_list'][$this->category_id];
		$document_fields['SUBCATEGORY_ID'] = empty ($this->subcategory_id) ? "" : $app_list_strings['Document_Main_Category'][$this->subcategory_id];
