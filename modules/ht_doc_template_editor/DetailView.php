...
$focus = new ht_doc_template_editor();

$detailView = new DetailView();
$offset=0;
if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
    $result = $detailView->processSugarBean("ht_doc_template_editor", $focus, $offset);
    if ($result == null) {
...
$xtpl=new XTemplate('modules/ht_doc_template_editor/DetailView.html');
$xtpl->assign("MOD", $mod_strings);
$xtpl->assign("APP", $app_strings);
$buttons = array(
    <<<EOD
            <input type="submit" class="button" id="editht_doc_template_editorButton" title="{$app_strings['LBL_EDIT_BUTTON_TITLE']}" accessKey="{$app_strings['LBL_EDIT_BUTTON_KEY']}" onclick="this.form.return_module.value='ht_doc_template_editor'; this.form.return_action.value='DetailView'; this.form.return_id.value='{$focus->id}'; this.form.action.value='EditView'" value="{$app_strings['LBL_EDIT_BUTTON_LABEL']}">
EOD
,
    <<<EOD
            <input title="{$app_strings['LBL_DUPLICATE_BUTTON_TITLE']}" accessKey="{$app_strings['LBL_DUPLICATE_BUTTON_KEY']}" class="button" onclick="this.form.return_module.value='ht_doc_template_editor'; this.form.return_action.value='index'; this.form.isDuplicate.value=true; this.form.action.value='EditView'" type="submit" name="button" value="{$app_strings['LBL_DUPLICATE_BUTTON_LABEL']}">
EOD
,
    <<<EOD
...
,
<<<EOD
            <input type="submit" class="button" id="editht_doc_template_editorButton" title="Template Wizard"  onclick="this.form.return_module.value='ht_doc_template_editor'; this.form.return_action.value='DetailView'; this.form.return_id.value='{$focus->id}'; this.form.module.value='DHA_PlantillasDocumentos'; this.form.action.value='generate_doc_wizard'" value="Template Wizard">
EOD
);
...
$xtpl->assign("BODY_HTML", json_encode(from_html($focus->description)));
