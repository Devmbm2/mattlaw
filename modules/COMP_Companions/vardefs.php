...
$dictionary['COMP_Companions'] = array(
    'table' => 'comp_companions',
    'audited' => true,
    'inline_edit' => true,
  ...
  array (
    ...
    'len' => 100,
    'size' => '20',
    'options' => 'relationship_to_main_client_list',
    'studio' => 'visible',
    'dependency' => false,
  ),
  'age' => 
...
VardefManager::createVardef('COMP_Companions', 'COMP_Companions', array('basic','assignable','security_groups'));