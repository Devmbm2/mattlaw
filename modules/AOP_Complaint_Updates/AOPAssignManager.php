...
class AOPAssignManager
{
    ...
    private function getLeastBusyCounts()
    {
        ...
        $res = $db->query("SELECT assigned_user_id, COUNT(*) AS c FROM complaints WHERE assigned_user_id IN ({$idIn}) AND deleted = 0 GROUP BY assigned_user_id ORDER BY COUNT(*)");
    ...
    private function getRoundRobinUser()
    {
        ...
        $file = create_cache_directory('modules/AOP_Complaint_Updates/Users/').$id.'lastUser.cache.php';
        $lastUserId = '';
