<?php
if(!class_exists('htLoginTrackerOutfittersLicense')) {
    class htLoginTrackerOutfittersLicense {
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false) {
            ...
            $validated = htLoginTrackerOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate() {
            ...
            $validated = htLoginTrackerOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null) {
            ...
            {
                $GLOBALS['log']->fatal('htLoginTrackerOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
            return $response;
        }//end of doValidate function
        ...
        public static function change() {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('htLoginTrackerOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add() {
            ...
            $response = htLoginTrackerOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API {
        private function get_default_payload($module,$custom_data = array()) {
            ...
            if (empty($custom_data['key'])){
                $key = htLoginTrackerOutfittersLicense::getKey($module);
            ...
            return $data;
        }//end of get_default_payload function
