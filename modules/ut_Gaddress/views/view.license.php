...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_GOOGLE_ADDRESS_LICENSE','Administration').': '.translate('LBL_GOOGLE_ADDRESS_LICENSE_TITLE','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        if(isset($outfitters_config['manage_licensed_users']) && $outfitters_config['manage_licensed_users'] == true) {
            ...
            $administration->retrieveSettings();
             ...
             if(isset($administration->settings['SugarOutfitters_'.$outfitters_config['shortname']]))
