...
class ht_doc_temp_letter_headViewDetail extends ViewDetail{
   ...
   protected function _displayJavascript() {  
      ...
      $url = "index.php?entryPoint=download_dha_document_template&type=ht_doc_temp_letter_head&id=".$this->bean->id;
