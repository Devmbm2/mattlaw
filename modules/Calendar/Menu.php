...
if(ACLController::checkAccess('Calendar', 'list', true))$module_menu[]=Array("index.php?module=Calendar&action=index&view=agendaDay", $mod_strings['LNK_VIEW_CALENDAR'],"Today");
/* if(ACLController::checkAccess('Calendar', 'list', true))$module_menu[]=Array("index.php?module=Calendar&action=upcoming_events_report", 'Upcoming Trials & Vacations Report', 'List', "FP_events");
 */
