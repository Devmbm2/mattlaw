...
class MattCalendarDashlet extends Dashlet {
    var $view = 'week';

    function MattCalendarDashlet($id, $def) {
        $this->loadLanguage('MattCalendarDashlet','modules/Calendar/Dashlets/');
    ...
    function displayOptions() {
        ...
        return parent::displayOptions() . $ss->fetch('modules/Calendar/Dashlets/MattCalendarDashlet/MattCalendarDashletOptions.tpl');
    }  
