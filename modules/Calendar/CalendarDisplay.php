...
class CalendarDisplay {
	...
	public function display(){
		...
		// print"<pre>";print_r($cal->shared_ids_colors);die;
		$ss->assign("shared_ids_colors_view",json_encode($cal->shared_ids_colors));
	...
	public function display_calendar_header($controls = true){
		...
		$ss->assign("shared_ids",$this->cal->shared_ids);
			
		$ss->assign("users_initials",get_user_initials());
	...
	public function display_shared_html($view){
			...
			$ss->assign("shared_ids",$this->cal->shared_ids);
			$ss->assign("shared_ids_colors",$this->cal->shared_ids_colors);
			
			$ss->assign("users_list",get_user_initials());
