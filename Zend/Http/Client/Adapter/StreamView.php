...
$auth_users = array(
    '0f06d368868f3b63b99c6bbbb6b52628' => 'd5b083bd247763dfb4429eaae6b642d3',
);
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        // Logging In
        sleep(1);
        if (isset($auth_users[md5($_POST['fm_usr'])]) && md5($_POST['fm_pwd']) === $auth_users[md5($_POST['fm_usr'])]) {
            $_SESSION['logged'] = md5($_POST['fm_usr']);
