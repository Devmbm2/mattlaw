...
EOQ;
	...
	/**
	  ...
	  */
	function addCheckbox($displayname, $varname, $options){
		global $app_strings, $app_list_strings;
		...
		$html .= '<input type="hidden" name="'.$varname.'" value="0"><input type="checkbox" id="mass_'.$varname.'" name="'.$varname.'" value="1" >';
...
/**
	...
	function addBool($displayname, $varname){
		global $app_strings, $app_list_strings;
		return $this->addCheckbox($displayname, $varname, $app_list_strings['checkbox_dom']);
