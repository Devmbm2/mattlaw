...
class SugarWidgetSubPanelDetailViewLink extends SugarWidgetField
{
	function displayList($layout_def)
	{
        ...
        {
			$link = ajaxLink("index.php?module=$module&action=$action&record={$record}{$parent}&offset={$layout_def['record_offset']}");
            if ($module == 'EAPM')
            {
                $link = "index.php?module=$module&action=$action&record={$record}{$parent}&offset={$layout_def['record_offset']}";
            }
