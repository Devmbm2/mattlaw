        ...
        $this->seed = $this->bean;
         ...
         $displayColumns = array();
			/* if (!empty($_REQUEST['displayColumns'])) { */
				/* print"<pre>";print_r($_REQUEST['displayColumns']); */
				
				
				$display = $this->listViewDefs[$module];
				foreach ($display as $num => $col) {
			...
			/* } else { */
				/* */
				if(!empty($_REQUEST['saved_search_select']) && $_REQUEST['saved_search_select'] == 'e6c4a926-1c39-564c-ba25-5d8a326a0b75'){
					unset($display['FILTER_6']);
				}
				if(!empty($_REQUEST['saved_search_select']) && $_REQUEST['saved_search_select'] == 'ab2585a3-56c7-9e83-735d-5d8a33c5581d'){
					unset($display['FILTER_5']);
				}
				if($_REQUEST['saved_search_select'] != 'ab2585a3-56c7-9e83-735d-5d8a33c5581d' && $_REQUEST['saved_search_select'] != 'e6c4a926-1c39-564c-ba25-5d8a326a0b75'){
					/* die('test'); */
					unset($display['FILTER_6']);
					unset($display['FILTER_5']);
				}
				 /* print"<pre>";print_r($this->listViewDefs[$module]); */
				foreach ($display as $col => $this->params) {
