    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!-- Nav tabs -->
                <h5 class="searchTabHeader mobileOnly basic">{$APP.LBL_QUICK_FILTER}</h5>
                <h5 class="searchTabHeader mobileOnly advanced active">{$APP.LBL_ADVANCED_SEARCH}</h5>
                <ul class="nav nav-tabs" role="tablist">
                    <li class="searchTabHandler basic"><a href="javascript:void(0)"
                    ...
                    <li class="searchTabHandler advanced active"><a href="javascript:void(0)"
